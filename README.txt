...
I call it "Find the non-arithmetic set"
...
Put another way, given 3 integers a,b,c, where a < b < c then b - a does no equal c - b

My original intention is to submit this to CodeWars as my first authored problem. My first
